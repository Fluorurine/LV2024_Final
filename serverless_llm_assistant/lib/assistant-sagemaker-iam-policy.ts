...
export class SageMakerIAMPolicyConstruct extends Construct {
	...
	constructor(
		scope: Construct,
		id: string,
		props: SageMakerIAMPolicyConstructProps
	) {
		super(scope, id);

		this.sageMakerPostgresDBAccessIAMPolicy = new iam.ManagedPolicy(
			this,
				...
				statements: [
					new iam.PolicyStatement({
						...
						resources: [
							...
							props.sagemaker_rds_access.processingSecurityGroupIdParameter
								.parameterArn,
					...
					new iam.PolicyStatement({
						...
						resources: [
							...
							props.agentDataBucket.arnForObjects("*"),
						],
					}),
					new iam.PolicyStatement({
